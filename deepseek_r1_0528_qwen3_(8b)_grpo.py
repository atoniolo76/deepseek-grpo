...
# Note: This is slightly slower due to Drive I/O, but it's permanent.
!huggingface-cli download unsloth/DeepSeek-R1-0528-Qwen3-8B \
    --local-dir "/content/drive/MyDrive/DeepSeek_Model" \
    --exclude "*.git*" "*.md"
...
model, tokenizer = FastLanguageModel.from_pretrained(
    model_name = "/content/drive/MyDrive/DeepSeek_Model",
...
dataset
# Define where you want to save it on Google Drive
dataset_save_path = "/content/drive/MyDrive/DAPO_Math_Dataset"
...
model.save_lora("/content/drive/grpo_lora")
